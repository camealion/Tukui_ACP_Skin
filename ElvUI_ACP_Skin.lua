local function cbResize(self, event, ...) -- What a bitch!
    for i=1,20,1 do
...
-- ACP Skin - Added by Camealion - Start
local SkinACP = CreateFrame("Frame")
	...
	local buttons = {
                ...
                for i=1,20,1 do
                    ...
                    --ACP_OnLoad:SetScript("OnShow", cbResize)
                    ACP_OnLoad:SetScript("OnUpdate", cbResize) -- Did I Say what a Bitch!
                end
				...
				-- Skin Dropdown box
				cSkinDropDownBox(ACP_AddonListSortDropDown, 130)
	...
	-- ACP Skin - Added by Camealion - End
 end)